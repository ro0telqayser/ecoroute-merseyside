...
export const IconCompare = ({ size = 16 }) => (
  <Icon size={size} d={<>
...
export const IconTrain = ({ size = 18 }) => (
  <Icon size={size} sw={1.8} d={<>
...
export const IconLightning = ({ size = 14 }) => (
